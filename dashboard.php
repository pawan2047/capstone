              ...
              <?php foreach ($progress_data as $course): ?>
                <tr>
                  ...
                  <td class="px-4 py-2 space-x-2">
                    ...
                    <a href="course.php?course_id=<?= $course['course_id'] ?>" class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded transition duration-150">
                      Continue Course
                    </a>
                    <!-- Drop Course button -->
                    <a href="drop_course.php?course_id=<?= $course['course_id'] ?>" onclick="return confirm('Are you sure you want to drop this course?');" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded transition duration-150">
                      Drop Course
                    </a>
                  </td>
                </tr>
